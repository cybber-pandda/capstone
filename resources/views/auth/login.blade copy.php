            ...
            <div class="card-body p-6">
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('identifier') is-invalid @enderror" name="identifier" id="identifier" value="{{ old('identifier') }}" placeholder="Enter your email or username" autofocus />
                        @error('identifier')
