...
<div class="section section-scrollable" style="margin-bottom: 20px;">
    <div class="container">
          ...
          <div class="row" style="margin-bottom: 20px;" id="downloadtoPDF">
                ...
                <div class="col-sm-4 col-xs-12"
                    ...
                    <div style="display: flex; flex-direction: column;margin-bottom:20px;">
                        <h4 style="margin-bottom: 0px;"><strong>Delivery Receipt</strong></h4>
                        <span><b>No:</b>
                            {{ $quotation->id ?? 'No PO provided' }}-{{ date('Ymd', strtotime($quotation->created_at)) }}</span>
                        <span><b>Delivery Date:</b> {{ $invoiceData->delivery_date ?? 'No delivey date' }}</span>
        ...
        @unless($isPdf)
        <div style="clear: both; margin-top: 40px;display:none;">
