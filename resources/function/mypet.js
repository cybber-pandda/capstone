$(document).ready(function () {
    ...
    let headers = isShelter != null ?
        ['Photo', 'Pet Name', 'Adopter Name', 'Breed', 'Color', 'Application Date', 'Application Status', 'Note', 'Action'] :
        ['Photo', 'Pet Name', 'Breed', 'Color', 'Application Date', 'Application Status', 'Note', 'Action'];
    ...
    var mypetDataTable = $(`#${tableId}`).DataTable({
        ...
        columns: [
            ...
            },
            {
                data: 'adoptername',
                class: 'px-5',
                visible: isShelter // Conditionally show this column based on isShelter
            },
            {
                data: 'petbreed',
                class: 'px-5'
    ...
    $(document).on('click', '.approve-btn', function () {
        ...
        Swal.fire({
            ...
            icon: 'warning',
            input: 'textarea',
            inputPlaceholder: 'Enter schedule for pick-up and Additional requirements.',
            inputAttributes: {
                'aria-label': 'Enter approval message'
            },
            ...
            if (result.isConfirmed) {
                let approveMessage = result.value; 
                approveAdopter(id, approveMessage);
            }
        });
    ...
    $(document).on('click', '.reject-btn', function () {
        ...
        Swal.fire({
            ...
            icon: 'warning',
            input: 'textarea', // set this to required
    ...
    function approveAdopter(id, approveReason) {
        $.ajax({
